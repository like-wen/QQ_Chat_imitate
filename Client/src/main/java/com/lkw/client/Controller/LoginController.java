       ...
       public void run() {
           ...
           link.setOnAction(e -> {
               ...
               alert.setContentText("本版本生效日期：2022年7月13日\n" +
                       ...
                       "欢迎来到File-Cloud！\n" +
                       "\n" +
                       "File-Cloud是由四川贰凌物联壹伴信息技术有限公司（下称“20物联1班”）提供的互联网软件服务。"+
                       "本服务条款（下称“服务条款”）是您与20物联1班之间关于您（“您”或“用户”）访问和使用" +
                       "File-Cloud以及20物联1班提供的其他服务（下称“服务”）的主要协议。您注册、登录File-Cloud或" +
                       "使用20物联1班提供的服务，即表示您同意接受服务条款，如您不同意该协议，请不要使用本服务。" +
                       "因此，敬请仔细阅读。\n" +
                       "\n" +
                       "20物联1班有权不时地对服务条款做任何修改和补充，并在File-Cloud网站上公布。" +
                       "服务条款的修改和补充将在公布时立即生效。您继续访问和使用File-Cloud即视为您接受修订后的服务条款。" +
                       "如您不同意修订后的服务条款，您应停止访问File-Cloud并拒绝使用服务或删除您在File-Cloud上的信息和帐户来终止接受服务。" +
                       "如果您代表某个机构而非您个人注册、登录和使用File-Cloud和/或我们其他的服务，" +
